...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <StatCard label="Total" value={stats.total || 0} color="bg-[#8a9e6e] text-black border border-[#7a8e5e]" />
        <StatCard label="En attente" value={stats.pending || 0} color="bg-[#8a9e6e] text-black border border-[#7a8e5e]" />
        <StatCard label="Confirmées" value={stats.confirmed || 0} color="bg-[#8a9e6e] text-black border border-[#7a8e5e]" />
        <StatCard label="Annulées" value={stats.cancelled || 0} color="bg-[#8a9e6e] text-black border border-[#7a8e5e]" />
      </div>
        {/* Filtres */}
  ...
  <tr>
    ...
    <th className="px-4 py-3 text-left text-sm font-semibold">Preom</th>
